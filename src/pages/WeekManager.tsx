...
export function WeekManager() {
    ...
    const handleSaveWeek = async () => {
        ...
        try {
            ...
            setSuccess(isEditing ? 'Semaine mise à jour avec succès' : 'Semaine ajoutée avec succès');
            handleCloseDialog();
            fetchWeeks();
        } catch (err: any) {
                                    ...
                                    {weeks.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={6} align="center">
                                                Aucune semaine n'a été créée. Cliquez sur "Ajouter une semaine" pour commencer.
                                            </TableCell>
                                        </TableRow>
                                    ) : (
                                        weeks.map((week) => (
                                            <TableRow key={week.id}>
                                                ...
                                                <TableCell>
                                                    {format(parseISO(week.start_date), 'dd/MM/yyyy', { locale: fr })}
                                                    {' au '}
                                                    {format(parseISO(week.end_date), 'dd/MM/yyyy', { locale: fr })}
                                                </TableCell>
                                                <TableCell>
                                                    {week.description ? (
                ...
                <DialogContent>
                    <Stack spacing={3} sx={{ mt: 1 }}>
                        ...
                        <FormControl fullWidth>
                            <InputLabel id="user-select-label">Participant assigné</InputLabel>
                            <Select
